...
parameter_estimation_settings['multistart_initialPointsDistributionType'] = 'sobol' #Can be 'uniform', 'gaussian', 'identical', 'grid', 'astroidal', or 'sobol', and 'shell'. Astroidal option has a high density of points towards the center while shell has a higher density at the edges of the prior distribution.
